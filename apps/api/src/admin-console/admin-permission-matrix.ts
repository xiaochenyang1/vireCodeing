...
const adminPermissionModules: AdminPermissionModuleCatalogItem[] = [
  ...
  },
  {
    ...
    summary: '审计货主/司机评价、图片与处置历史，并可隐藏或恢复评价展示。',
  },
  {
    key: 'finance',
    title: '财务操作台',
...
const adminPermissionCapabilities: AdminPermissionCapabilityCatalogItem[] = [
  ...
  },
  {
    ...
    summary:
      '读取货主实名/企业认证队列、单条详情、认证附件、审核事件，并能执行实名、企业认证的单条通过 / 驳回。',
    actions: ['read', 'write'],
    riskLevel: 'high',
    apiPaths: [
  ...
  },
  {
    ...
    summary:
      '读取货主发票申请队列、单条详情、审核事件和已开票文本发票，并能执行单条通过 / 驳回。',
    actions: ['read', 'write'],
    riskLevel: 'high',
    apiPaths: [
  ...
  },
  {
    ...
    summary: '读取货主/司机评价方向、评分、内容、标签、图片附件和处置历史。',
    actions: ['read'],
    riskLevel: 'sensitive',
    apiPaths: [
      '/admin/evaluations',
