...
const defaultModules = [
  ...
  },
  {
    ...
    summary: '查看货主实名/企业认证队列、附件预览、审核事件，并执行单条通过或驳回。',
  },
  {
    key: 'shipper-invoice',
    title: '发票申请审核台',
  ...
  },
  {
    ...
    summary:
      '分页查看货主帮助中心工单、按 SLA/认领状态筛队列、查看 SLA 提醒和详情，并先认领 open 工单再推进 pending -> processing -> resolved 状态流转；也支持执行超时升级扫描并把升级消息回流给货主。',
  },
  {
    ...
    summary:
      '处理货主/司机异常工单，查看受理 / 解决 SLA 提醒，按赔付状态、申诉状态、SLA 状态、认领状态和认领客服筛队列；也能先认领到当前客服，再执行超时升级扫描并把升级消息回流给相关方。',
  },
  {
    key: 'shipper-coupon',
    title: '货主优惠券发放台',
